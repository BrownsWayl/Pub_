...
export const PositionPage = () => {
    ...
    // 🚀 注入一组逼真的测试数据，方便开发和联调，左下角会动态计算这组数据的合计
    const rawData = [
        { key: '1', orderId: '8839012', accountId: '55120', type: 'Buy', symbol: 'XAUUSD', volume: '0.10', openPrice: '2350.45', openTime: '2026-07-16 10:15:30', sl: '2340.00000', tp: '2380.00000', fee: '-1.50', swaps: '0.00', profit: '120.50' },
        { key: '2', orderId: '8839015', accountId: '55120', type: 'Sell', symbol: 'EURUSD', volume: '0.50', openPrice: '1.08540', openTime: '2026-07-16 11:20:12', sl: '1.09000', tp: '1.08000', fee: '-5.00', swaps: '-0.85', profit: '45.00' },
        { key: '3', orderId: '8839021', accountId: '861005', type: 'Buy', symbol: 'GBPUSD', volume: '1.00', openPrice: '1.27420', openTime: '2026-07-15 14:02:55', sl: '1.26500', tp: '1.29000', fee: '-10.00', swaps: '-1.20', profit: '-150.00' },
        { key: '4', orderId: '8839035', accountId: '861005', type: 'Buy', symbol: 'XAUUSD', volume: '0.20', openPrice: '2362.10', openTime: '2026-07-15 16:45:18', sl: '2350.00000', tp: '2400.00000', fee: '-3.00', swaps: '0.00', profit: '240.00' },
        { key: '5', orderId: '8839044', accountId: '55120', type: 'Sell', symbol: 'USDJPY', volume: '0.30', openPrice: '158.200', openTime: '2026-07-14 09:30:05', sl: '159.500', tp: '156.000', fee: '-4.50', swaps: '1.10', profit: '85.40' }
    ];
    ...
    // 🚀【高精准动态合计】：基于当前页面展示的数据（currentPageData）进行动态求和
                ...
                <div className={styles.tableTitleArea} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%' }}>
                    ...
                    {!isMobile && (
                        <div className={styles.breadcrumb}>
                            <span>我的交易</span> &gt; <span className={styles.breadcrumbActive}>持仓</span>
                        </div>
                    )}
                </div>
